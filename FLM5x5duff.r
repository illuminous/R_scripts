...
FuelsWest<- read.table("Fuel_load_west_analysis_set_20120412_2008_5x5_Mean_FLMLoading.csv",header = TRUE, sep = ",", row.names= 1)
head(FuelsWest08_5x5)
summary(FuelsWest08_5x5)
...
plot(FuelsWest$Mean Duff, FuelsWest$Duff_kg/sq m, xlim = c(0,100), ylim= c(0,100), ylab = "Litter (tons per acre)", xlab =" FLMF")
